...
- **본문 강조 형광펜**: 줄글 속 강조(섹터명 등)·AI 분석 섹션 제목은 **연노란 형광펜 `--mark #FFF3A0` + 진한 회색 글씨 `--ink`**. 클래스 `.sa-sector-hl`(본문 강조)·`.sa-analysis-label`(섹션 제목). 줄글 내 강조는 이 연노란 형광펜으로 통일(메모 박스와는 별개).
